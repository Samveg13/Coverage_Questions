...
def via_cpn(cpn):
    ...
    try:
        ...
        doc_quotation = ""
        doc_specimen_policy = ""
        # print(response_json[0]['documents'])
        # print("************")
...
def process_tickets(file_path):
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            headers = {
                'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Im43WDdPcU9aNU91MmZnQW9YaW15NyJ9..ONTvGNrZYOrM7WaYMi6FY3NtCpaxDWPVwAOteFChAtpqdJ5Y9iQUQaS-yHmDk5OLnQRQX8S4r7EJHzt7wgJA09-pI7s6W5Fujnvkw_viM44bOCOCQd2ALfuOQKrrws0HqJ3dC6WOcs44GzWvG6WZ5U2w_WHQi20FmhD3oKO_xPUuxqlffkdHIc9OO3dCZljyK1oW3tHhyJ4AhvuCGBQGrzodlXAdDaU2nbUCEU51TkeywiELi6bJpCLVa27W9dRZ8YkIBwv8KMQ3kfZOJmAk8mO1xzNhsOl1YyZPl4VsXgXvRCYAB1x05fW2DFmZRpihuJ_PmwjJEWdjgmpnMDpb0A'
            }
