...
def download_pdf(url, filename,index):
    ...
    return DOWNLOAD_DIR+"/"+str(index)+'/'+str(filename)
...
def process_tickets(file_path):
    ...
    for index, row in df.iterrows():
        os.makedirs('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/Dataset/Data'+str(index),exist_ok=True)
