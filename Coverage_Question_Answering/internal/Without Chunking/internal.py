...
def via_cpn(cpn):
    try:
        ...
        return doc_quotation, doc_specimen_policy
...
def rag_pipe(quotation_text, specimen_policy_text, user_extract_query):
    ...
    try:
        ...
        print()
        documents = [extract_pdf_text(quotation_text),extract_pdf_text(specimen_policy_text)]
        print(documents)
...
def process_tickets(file_path):
    ...
    for index, row in df.iterrows():
        print("================================================")
        if os.path.exists('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/internal/llama-index/documents/quotation.pdf'):
            os.remove('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/internal/llama-index/documents/quotation.pdf')
        if os.path.exists('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/internal/llama-index/documents/specimen_policy.pdf'):
            os.remove('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/internal/llama-index/documents/specimen_policy.pdf')
    ...
    pd.DataFrame(responses).to_csv('/Users/samveg.shah/Desktop/Coverage_Questions/Coverage_Question_Answering/Generated/output22_all.csv', index=False)
